#Pintos课程报告
## 介绍
本文档来自于我2021年操作系统课的课程设计中的报告文档，该文档的标准是按照学校要求来的。实现了CS-162 2021fall 的hw2（shell）还有团队作业部分的project1（userprog）和project2(scheduling)，因为环境配置的问题，本项目采用的代码框架是pintos-anon-master，为了适配2021年的新框架，我修改了测试集，所以这个仓库中的内容不一定适用于你的在线判题机器，仅供参考。

本文档是由word版本修改而来的课程报告，所以由一些地方可能会出现于word文档不符的情况，word文档会导出成pdf上传至该项目，方便后来者学习。

如果这个仓库对你有所帮助，那我将感到高兴，如果你在执行过程中遇到一了不能解决的问题，欢迎和我讨论，你可以在issues直接提问，我每天都会定期查看。
